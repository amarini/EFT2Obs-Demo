...
namespace Rivet
{
    void Higgs2GGFiducialAndDifferential::init()
    {
        ...
        book(h_pt_gg_, "pt_gg", {0, 15, 30, 45, 80, 120, 200, 350, 500});
        book(h_njets_eta2p5_, "n_jets_eta2p5", 5, 0, 5);
        book(h_jet_pt_eta2p5_, "h_jet_pt_eta2p5", {0, 15, 30, 45, 80, 120, 200, 350, 500});
        book(h_njets_eta4p7_, "n_jets_eta4p7", 5, 0, 5);
        book(h_jet_pt_eta4p7_, "h_jet_pt_eta4p7", {0, 15, 30, 45, 80, 120, 200, 350, 500});
    }
